#!/usr/bin/python3
""" ItrBFS.py
Student Names: Roy Lee and Lucas Besbati
UW NetIDs: royl14 and besbati
...
class ItrBFS:
    ...
    def IterativeBFS(self, initial_state): # This is almost identical to DFS but with some changes
